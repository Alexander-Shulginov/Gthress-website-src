...
function calcDevice(e) {
	...
	return (
		!c &&
			...
			((c = r.match(/(Version)\/([\d.]+)/)), c || (c = [0, 1, "13_0_0"]), (f = !1)),
...
function updateSlides() {
	...
	if (
		(Object.assign(e, { slides: p, snapGrid: m, slidesGrid: f, slidesSizesGrid: h }),
...
function onTouchStart(e) {
	...
	(!r.touchStartForcePreventDefault && !b) || d.isContentEditable || o.preventDefault(),
		t.params.freeMode &&
	...
	if (
		...
		void 0 === a.startMoving &&
			((r.currentX === r.startX && r.currentY === r.startY) ||
				(a.startMoving = !0)),
		a.isScrolling ||
			(s.zoom && s.params.zoom && s.params.zoom.enabled && a.evCache.length > 1))
	)
...
function onTouchEnd(e) {
	...
	if (
		...
		return;
	const { params: i, touches: r, rtlTranslate: n, slidesGrid: l, enabled: o } = t;
	if (!o) return;
	if (!i.simulateTouch && "mouse" === e.pointerType) return;
	let d = e;
	if (
...
function Pagination(e) {
	...
	function p(e) {
		if (!e.target.matches(classesToSelector(t.params.pagination.bulletClass))) return;
		e.preventDefault();
		const s = elementIndex(e.target) * t.params.slidesPerGroup;
		...
		"string" == typeof e.el &&
			...
			s &&
				...
				(t.params.uniqueNavElements &&
					...
					s.length > 1 &&
						(s = s.filter(
							(e) => elementParents(e, ".swiper")[0] === t.el
						)[0])),
...
function Scrollbar(e) {
	...
	function f() {
		...
		(s.style.width = ""),
			...
			t.isHorizontal() ? (s.style.width = `${l}px`) : (s.style.height = `${l}px`),
...
function Zoom(e) {
	...
	function v(e) {
		...
		if (((n = !1), (l = !1), c.push(e), !(c.length < 2))) {
			...
			p.imageEl && (p.imageEl.style.transitionDuration = "0ms"), (d = !0);
		}
	}
	function w(e) {
		if (!g(e)) return;
	...
	function S(e) {
		...
		1 === o && C && ((i = void 0), (n = void 0)),
			(s.scale = C || p.imageWrapEl.getAttribute("data-swiper-zoom") || a.maxRatio),
...
function EffectCube(e) {
	...
	const i = (e, t, s) => {
		...
		a ||
			((a = createElement("div", "swiper-slide-shadow-" + (s ? "left" : "top"))),
			e.append(a)),
			i ||
				((i = createElement(
					"div",
